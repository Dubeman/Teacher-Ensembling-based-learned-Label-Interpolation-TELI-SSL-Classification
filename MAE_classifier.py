...
from MAE_utils import setup_seed
...
if __name__ == '__main__':
    ...
    train_dataset = torchvision.datasets.MNIST('data', train=True, download=True, transform=Compose([ToTensor(), Normalize(0.5, 0.5)]))
    ...
    model = ViT_Classifier(model.encoder, num_classes=100).to(device)
